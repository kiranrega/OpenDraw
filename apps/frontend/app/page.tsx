...
const DrawingCursor = ({ x, y, color, name }: { x: string, y: string, color: string, name: string }) => (
  ...
  >
    ...
    <div className="absolute -top-8 -left-2 bg-gray-800 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
      {name}
    </div>
  </motion.div>
);
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="pt-20 pb-16 bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
        ...
        <FloatingShape delay={0}>
          <div className="w-20 h-20 bg-blue-100 rounded-full opacity-60" style={{ top: '10%', left: '10%' }} />
        </FloatingShape>
        <FloatingShape delay={0.2}>
          <div className="w-16 h-16 bg-purple-100 rounded-lg opacity-60" style={{ top: '20%', right: '15%' }} />
        </FloatingShape>
        <FloatingShape delay={0.4}>
          <div className="w-12 h-12 bg-green-100 rounded-full opacity-60" style={{ bottom: '30%', left: '20%' }} />
        </FloatingShape>
        <FloatingShape delay={0.6}>
          <div className="w-14 h-14 bg-yellow-100 rounded-lg opacity-60" style={{ bottom: '20%', right: '10%' }} />
        </FloatingShape>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">New: Real-time collaboration is here!</span>
            </motion.div>
            ...
            >
              <motion.button 
                className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-xl flex items-center space-x-2 text-lg font-semibold"
                whileHover={{ 
                  scale: 1.05,
              ...
              <motion.button 
                className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl flex items-center space-x-2 text-lg font-semibold bg-white/80 backdrop-blur-sm"
                whileHover={{ 
                  scale: 1.05,
                  borderColor: "#6B7280",
          ...
          >
            <motion.div 
              className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden mx-auto max-w-4xl"
            ...
            >
              <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center space-x-2">
                ...
                <span className="ml-4 text-sm text-gray-600">DrawFlow - Collaborative Drawing</span>
                <motion.div 
                ...
                >
                  ...
                  <span className="text-xs text-gray-500">3 users online</span>
                </motion.div>
              </div>
              <div className="h-80 bg-gradient-to-br from-blue-50 to-purple-50 relative overflow-hidden">
                ...
                <DrawingCursor x="20%" y="30%" color="bg-blue-500" name="Alex" />
                <DrawingCursor x="60%" y="45%" color="bg-green-500" name="Sarah" />
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                variants={itemVariants}
                className={`bg-gradient-to-br ${feature.bgColor} p-8 rounded-2xl hover:shadow-lg transition-all duration-300 group cursor-pointer`}
      ...
      {/* CTA Section */}
      <AnimatedSection className="py-20 bg-gradient-to-r from-blue-500 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <motion.button 
            className="bg-white text-blue-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transition-all duration-200 flex items-center space-x-2 mx-auto"
